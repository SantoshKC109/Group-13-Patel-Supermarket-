...
header('Refresh: 2; URL = home.php');
  ...
  $sql = "SELECT user.*, user_role.role FROM user INNER JOIN user_role ON user.role_id = user_role.id  WHERE user.username = '".$name."'";
...
<span> Remember me</span> <br/><br/>
  ...
  <a href="pass-reset.php" class="btn btn-yellow" >Forget Password</a>
